...
namespace ClinicManager.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240328130147_EraseConfirmationCodeColumnFromAppointmentTable")]
    partial class EraseConfirmationCodeColumnFromAppointmentTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClinicManager.Domain.Core.Appointments.Token", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClinicManager.Domain.Core.Appointments.Token", b =>
                {
                    b.HasOne("ClinicManager.Domain.Core.Appointments.Appointment", null)
                        .WithOne("Token")
                        .HasForeignKey("ClinicManager.Domain.Core.Appointments.Token", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
